...
class Initial implements AddressFormState {
  const Initial();
...
class Loading implements AddressFormState {
  const Loading();
...
@override
String toString() {
  return 'AddressFormState.loading()';
}
...
class Success implements AddressFormState {
  const Success();
...
@override
String toString() {
  return 'AddressFormState.success()';
}
...
class Error implements AddressFormState {
...
@override
String toString() {
  return 'AddressFormState.error(errorKey: $errorKey)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $AddressFormStateCopyWith<$Res> {
