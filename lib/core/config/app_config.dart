...
abstract final class AppConfig {
  ...
  static String get revenueCatEntitlementId =>
      ApiKeys.revenueCatEntitlementId.trim();

  static String get revenueCatTestStoreApiKey =>
      ApiKeys.revenueCatTestStoreApiKey.trim();

  static bool get hasRevenueCatTestStoreKey =>
