...
Poinformuj użytkownika, że proces jest zakończony i gotowe prompty czekają na dole pliku `PUBLISH.md`. Poleć mu napisanie `next`.

Jak napisze `next`, dopiero wtedy zapoznaj się z plikiem `docs/commands/07_publish/05_publish-save-icon.md` — nie wcześniej!