...
Plan musi obejmować sekcje `### Must-Have` oraz `## Store Screenshots Plan` z pliku `docs/IDEA.md`
...
Upewnij się że wszelkie operacje dodawania, edycji, usuwania będą obsłużone bez problemu.
