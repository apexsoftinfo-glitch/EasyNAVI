...
CEL: ustalić pomysł na aplikację mobilną iOS/Android dla użytkownika.
...
Gdy użytkownik odpowie `"next"`, przejdź do wykonania polecenia zawartego w `docs/commands/01_start/04_start-niche.md`.
